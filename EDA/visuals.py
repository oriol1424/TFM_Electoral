...
def _limpiar_caracteres_especiales(texto: str) -> str:
    """Limpia caracteres corruptos que causan errores en fuentes de texto."""
    if not isinstance(texto, str): return texto
    return texto.replace('�', '').replace('', '')

def plot_votos_apilados_provincial(df_plot: pd.DataFrame, title: str):
    """Barras apiladas del peso relativo (%) de cada candidatura por provincia."""
...
def plot_histogram(
    ...
    """Histograma con línea KDE para una variable numérica."""
    sns.set_theme(style="whitegrid")
...
def plot_boxplot(
    ...
    """Boxplot para comparar una variable numérica a través de categorías."""
    sns.set_theme(style="whitegrid")
    plt.figure(figsize=figsize)
...
def plot_distribution_analysis(
    ...
    """Figura combinada con boxplot superior e histograma con KDE inferior, ideal para outliers."""
    sns.set_theme(style="whitegrid")
...
def plot_correlation_heatmap(
    ...
    """Mapa de calor de correlaciones con máscara en el triángulo superior."""
    sns.set_theme(style="whitegrid")
...
def plot_scatter_regression(
    ...
    """Scatter con línea de regresión y coeficiente de Pearson en la leyenda."""
    sns.set_theme(style="whitegrid")
...
def plot_missing_demographics(df_nulls: pd.DataFrame, df_pob: pd.DataFrame, anyo: str, title_suffix: str = "") -> None:
    """Perfil demográfico (tamaño y provincia) de los municipios con nulos."""
...
def plot_histogram_with_reference(
    ...
    """Histograma con KDE y línea de referencia vertical (media/total nacional)."""
    sns.set_theme(style="whitegrid")
    plt.figure(figsize=figsize)
...
def plot_barh_with_reference(
    ...
    """Barras horizontales ordenadas con línea de referencia; color diferenciado arriba/abajo."""
    sns.set_theme(style="whitegrid")

...
\subsection{La metamorfosis de los clivajes: Del modelo de clases al paradigma de Piketty}
...
\subsection{El voto económico a la primacía de los \textit{fundamentals} estructurales}
...
\subsection{El municipio como unidad de análisis: Heterogeneidad, INE y el archivo SEA}
...
\subsection{La ``venganza'' de los territorios olvidados y el sesgo de la despoblación}
...
\subsection{Inferencia Bayesiana y datos composicionales en sistemas multipartidistas}
...
\subsection{Machine Learning y la captura de no-linealidad en el bienestar social}
...
\subsection{La Ley D'Hondt y la Geografía de la Representación: El Doble Filtro Electoral}
...
\subsection{El reparto inicial y la desigualdad del voto}
...
\subsection{La Barrera Electoral Legal del 3\%}
...
\subsection{El Algoritmo D'Hondt y el ``Umbral Natural''}
...
\subsection{La ``España Vaciada'' y el Sesgo de Concentración}
